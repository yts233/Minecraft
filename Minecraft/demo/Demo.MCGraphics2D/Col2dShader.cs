...
{
    public class Col2dShader : ShaderBase
    {
...
void main(){
    FragColor=Color;
        ...
        public Col2dShader() : base(new ShaderBuilder().AttachVertexShader(VertexShaderSource).AttachFragmentShader(FragmentShaderSource))
        {
